...
<!-- ******************************페이징*******************-->
				<div class="text-center">
					<ul class="pagination post-pagination">
						...
						<li class="page"><a href="shop_korean.do?pnum=1&genre_no=${param.genre_no }">1</a>
						</li>
						<li class="page"><a href="shop_korean.do?pnum=2&genre_no=${param.genre_no }">2</a>
						</li>
						<li class="page"><a href="shop_korean.do?pnum=3&genre_no=${param.genre_no }">3</a>
						</li>
						<li class="page"><a href="shop_korean.do?pnum=4&genre_no=${param.genre_no }">4</a>
